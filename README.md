...
>
> ## Реализация ##
> Существет три основные сущности: `Вид отхода`, `Хранилище`, `Организация`. Связь между ними происходит через дополнительные модели, указанные выше. После создания и подключения всех сущностей организация может сгенерировать любой доступный вид отхода. Он будет положен на счет организации вместе с остальными отходаим, откуда организация может отправить их на переработку. При достижении максимального запаса отхода в хранилище необработанный отход вернется на счет организации. Последовательность обхода хранилищей выбирается по наименьшему расстоянию.
>
